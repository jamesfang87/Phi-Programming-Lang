...
std::unique_ptr<Block> Parser::parse_block() {
    // make sure that the block starts with an open brace, exit and emit error otherwise
...
template <typename T,
          typename F> // T is the type to return, F is the member function of Parser to use
